...
# Normally not used
# LOCAL_INCLUDES = -I$(LOCALTOP)/src/[a local directory here]
...
# slrs_spk.  
# Currently the following is redundant with 
# the definition in make.cbin
slrs_spk_LD_OPTS = 
...
SRCS	=   sample1_digrefl.c \
                s1_print_diagnostics.c \
                s1_symb_layer.c
