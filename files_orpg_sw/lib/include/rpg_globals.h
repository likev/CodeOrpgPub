 ...
 * $Id: rpg_globals.h,v 1.42 2012/11/28 15:27:40 steves Exp $
 * $Revision: 1.42 $
 * $State: Exp $
 */
...
typedef struct { 
    ...
    int timing;             /* timing, ELEVATION_PROD, VOLUME_PROD, 
                               RADIAL_PROD, or, if >= 0, time window size in 
    ...
    int rpg_elev_index;     /* RPG elevation index within the volume scan; Driving input
                               only. */
    char *buf[MAXN_IBUFS];  /* buffer storing the data */
    int bufptr[MAXN_IBUFS]; /* MEM pointer returned by get_inbuf */
...
typedef struct { 
    ...
    int type;               /* data type number */
    int timing;             /* timing, ELEVATION_PROD, VOLUME_PROD, 
                               RADIAL_PROD, or, if >= 0, genaration
...
typedef struct {
    ...
    int ptr;                    /* offset in terms of MEM array */
...
#define IB_get_inbuf ib_get_inbuf__
#define IB_rel_inbuf ib_rel_inbuf__
#define IB_reg_inputs ib_reg_inputs__
#define IB_get_id_from_name ib_get_id_from_name__
#define OB_reg_outputs ob_reg_outputs__
#define OB_get_outbuf ob_get_outbuf__
#define OB_rel_outbuf ob_rel_outbuf__
#define OB_get_id_from_name ob_get_id_from_name__
#define OB_tag_outbuf_wreq ob_tag_outbuf_wreq__
...
#define itoc_os32 itoc_os32__
#define wait_c wait_c__
#define btest_short btest_short__
#define register_adapt register_adapt__
#define SS_send_summary_array ss_send_summary_array__
#define VS_send_volume_status vs_send_volume_status__
#define PS_get_current_elev_index ps_get_current_elev_index__
#define PS_get_current_vol_num ps_get_current_vol_num__
#define PS_get_vol_stat_vol_num ps_get_vol_stat_vol_num__
#define PS_get_elev_angle ps_get_elev_angle__
#define PRQ_check_data prq_check_data__
#define PRQ_check_req prq_check_req__
#define INIT_process_argv init_process_argv__
...
#define IB_get_inbuf ib_get_inbuf_
#define IB_rel_inbuf ib_rel_inbuf_
#define IB_reg_inputs ib_reg_inputs_
#define IB_get_id_from_name ib_get_id_from_name_
#define OB_reg_outputs ob_reg_outputs_
#define OB_get_outbuf ob_get_outbuf_
#define OB_rel_outbuf ob_rel_outbuf_
#define OB_tag_outbuf_wreq ob_tag_outbuf_wreq_
#define OB_get_id_from_name ob_get_id_from_name_
#define SS_send_summary_array ss_send_summary_array_
#define VS_send_volume_status vs_send_volume_status_
#define PS_get_current_elev_index ps_get_current_elev_index_
#define PS_get_current_vol_num ps_get_current_vol_num_
#define PS_get_vol_stat_vol_num ps_get_vol_stat_vol_num_
#define PS_get_elev_angle ps_get_elev_angle_
#define PRQ_check_data prq_check_data_
#define PRQ_check_req prq_check_req_
#define INIT_process_argv init_process_argv_
#define date(a) date_(a)
...
int OB_get_outbuf (int *mem, int *dattyp, int *bufsiz, 
...
/* The following functions are define in rpg_adpt_data_elems.c */
void ADE_initialize();
int ADE_update_ade(int new_vol);
int ADE_update_ade_by_event(en_t event_id);

/* The following functions are defined in rpg_timer_services.c */
