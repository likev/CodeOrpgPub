...
# $Author: garyg $
# $Locker:  $
# $Date: 2007/01/05 18:02:23 $
# $Id: rms_interface.mak,v 1.4 2007/01/05 18:02:23 garyg Exp $
# $Revision: 1.4 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lrms_message -lrms_util -lrms_socket_mgr -lrpgc -lorpg -linfr -lm
DEBUG_LOCALLIBS = -lrms_message -lrms_util -lrms_socket_mgr -lrpgc -lorpg -linfr -lbzip2 -lm
...
SRCS = rms_interface.c 

ADDITIONAL_OBJS =

TARGET = rms_interface
