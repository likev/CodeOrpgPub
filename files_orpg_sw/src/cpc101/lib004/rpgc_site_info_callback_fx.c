 ...
 * $Author: steves $
 * $Locker:  $
 * $Date: 2007/03/08 18:28:08 $
 * $Id: rpgc_site_info_callback_fx.c,v 1.2 2007/03/08 18:28:08 steves Exp $
 * $Revision: 1.2 $
 * $State: Exp $
 */
...
/*
  ...
  RPGC_reg_site_info(). When the struct below is filled with new values,
...
int RPGC_site_info_callback_fx( void *struct_address )
{
  ...
  ret = RPGC_ade_get_string_values( "",
