 ...
 * $Id: cvg_orpg_product.h,v 1.5 2009/05/15 17:52:35 ccalvert Exp $
 * $Revision: 1.5 $
 * $State: Exp $
 */
...
/*------------------------------------------------------------------------
  This file is a modification of the ~/include/orpg_product.h file 
  intended for Build 11.  The purpose of this file (along with 
  cvg_xdr_infra.c) is to 
  ...
  CVG uses this file instead of  ~/include/orpg_product.h
  -----------------------------------------------------------------------*/
...
/*
 * Date: 2006/05/30 22:02:26 
 * Id: orpg_product.h
 * Revision: 1.8 
 */
/* CVG NOTE: With a patch received from Z. Jing on 7/16/07, the RCS header  */
/*           had an earlier version and date for some reason. */
/*
 * RCS info
 * $Author: ccalvert $
 * $Locker:  $
...
typedef struct {
    float azimuth;      /* azimuth of the center of the radial in 
                   degrees */
    float elevation;        /*  */
...
/*     char *name;          */ /*  */
/*     float lat;           */ /* latitude location of the center of sweep */
/*     float lon;           */ /* longitude location of the center of sweep */
