 ...
 * $Id: cvg_xdr_infra.c,v 1.6 2009/05/15 17:52:35 ccalvert Exp $
 * $Revision: 1.6 $
 * $State: Exp $
 */
...
/*------------------------------------------------------------------------
  ...
  cvg_orpg_product.h) is to 
  1. permit CVG to be compiled and used with the latest updates from the 
  ...
  CVG uses this file instead of  ~/src/cpc100/lib007
  -----------------------------------------------------------------------*/
...
/*  For CVG, include cvg_orpg_product.h rather than orpg_product.h */
...
****************************************************************/
int cvg_RPGP_product_serialize (void *prod, char **serial_data);
int cvg_RPGP_product_deserialize (char *serial_data,
                        int size, void **prod);
int cvg_RPGP_product_free (void *prod);
...
/***************************************************************
    ...
    As of CVG 8.8, none of the debug functions are used.
****************************************************************/
...
/* /////////////////////////////////////////////////////////////////////// */
/***************************************************************
    FUNCTION DEFINITIONS COPIED FROM orpg_xdr.c 
...
******************************************************************/
/*  CVG changes the name to avoid collision with ORPG library */
...
int cvg_RPGP_product_deserialize (char *serial_data, int size, void **prod) {
    XDR xdrs;
    RPGP_product_t *p;
    int ret;
...
/***************************************************************
    ...
    NOTE: If needed, CVG would use contents of xdr_test.c 
          (last verified with Build 11 rel 1.2) 
          The functions in rpgp_gen_prod_debug.c are not up to date
    AS OF CVG 8.8, none of the debebugging functions are used.
