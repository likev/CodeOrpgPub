...
# $Id: levelII_stats_ICAO_ldmping_encoder.mak,v 1.6 2012/08/21 13:42:18 ccalvert Exp $
# $Revision: 1.6 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lorpg -linfr -lRPG_LDM -lbz2 -lroc_level2
...
SRCS =	levelII_stats_ICAO_ldmping_encoder.c

TARGET = levelII_stats_ICAO_ldmping
