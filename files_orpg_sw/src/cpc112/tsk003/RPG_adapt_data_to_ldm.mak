...
# $Id: RPG_adapt_data_to_ldm.mak,v 1.3 2012/08/21 13:42:12 ccalvert Exp $
# $Revision: 1.3 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lorpg -linfr -lRPG_LDM -lbz2 -lm -lroc_level2
...
SRCS =	RPG_adapt_data_to_ldm.c

TARGET = RPG_adapt_data_to_ldm
