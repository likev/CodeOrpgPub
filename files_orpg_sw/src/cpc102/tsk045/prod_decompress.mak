...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 19:32:45 $
# $Id: prod_decompress.mak,v 1.7 2014/03/07 19:32:45 steves Exp $
# $Revision: 1.7 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lorpg -linfr -lrpgc -lm -lbz2 -lz
...
SRCS = prod_decompress.c orpgpat.c decompress_functs.c

ADDITIONAL_OBJS =

TARGET = prod_decompress
