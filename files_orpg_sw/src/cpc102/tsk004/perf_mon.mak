...
# $Id: perf_mon.mak,v 1.4 2014/03/18 18:02:44 jeffs Exp $
# $Revision: 1.4 $
# $State: Exp $
...
LOCAL_INCLUDES = `pkg-config --cflags libgtop-2.0`

# You can also include architecture specific includes, if needed, by
# defining $(ARCH)_INC and then adding it to the list of ALL_INCLUDES.

LOCAL_DEFINES = -DUSE_NLS -DPACKAGE=\"systat\" -DLOCALEDIR=\"/usr/local/share/locale\"
...
LIBPATH = `pkg-config --libs libgtop-2.0`
...
ADDITIONAL_OBJS = $(ARCH)/signals.o
