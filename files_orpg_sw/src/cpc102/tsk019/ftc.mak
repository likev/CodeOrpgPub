...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 19:35:20 $
# $Id: ftc.mak,v 1.3 2014/03/07 19:35:20 steves Exp $
# $Revision: 1.3 $
# $State: Exp $
...
SRCS =  ftc_main.c ftc_file.c ftc_process_c.c ftc_convert.c ftc_scan.c \
        ftc_utils.c ftc_global.c ftc_include.c ftc_equiv.c ftc_replace.c \
        ftc_write.c
