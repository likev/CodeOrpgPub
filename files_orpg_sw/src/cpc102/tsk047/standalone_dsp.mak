...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 19:31:23 $
# $Id: standalone_dsp.mak,v 1.8 2014/03/07 19:31:23 steves Exp $
# $Revision: 1.8 $
# $State: Exp $
...
LOCAL_DEFINES = -DC_NO_UNDERSCORE -DSTANDALONE_DSP
...
LIBPATH =
LOCAL_LIBRARIES = $(LIBDIR)/libinfr.a -lz -lbz2
...
SRCS =	standalone_dsp.c \
	dsp_aux_funcs.c

ADDITIONAL_OBJS =

TARGET = standalone_dsp
