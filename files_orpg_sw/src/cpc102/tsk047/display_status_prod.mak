...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 19:35:33 $
# $Id: display_status_prod.mak,v 1.7 2014/03/07 19:35:33 steves Exp $
# $Revision: 1.7 $
# $State: Exp $
...
LOCAL_LIBRARIES = $(C_ALGORITHM_LIBS) -lbz2 -lz
...
SRCS =	display_status_prod.c \
	dsp_aux_funcs.c

ADDITIONAL_OBJS =

TARGET = display_status_prod
