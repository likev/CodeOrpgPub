...
# $Id: hci_basedata_tool.mak,v 1.5 2014/03/07 19:35:04 steves Exp $
# $Revision: 1.5 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lhci -lorpg -linfr -lm
...
SRCS =	hci_basedata_tool.c \
	hci_basedata_tool_display.c \
	hci_basedata_tool_functions.c \
	hci_basedata_tool_colors.c \
	hci_basedata_tool_interrogate.c

TARGET = hci_basedata_tool
