/*	hci_basedata_tool.h - This header file defines		*
 ...
 * $Author: ccalvert $
 * $Locker:  $
 * $Date: 2009/10/30 20:53:02 $
 * $Id: hci_basedata_tool.h,v 1.7 2009/10/30 20:53:02 ccalvert Exp $
 * $Revision: 1.7 $
 * $State: Exp $
 */
...
#define	VELOCITY_MIN			-127.0*MPS_TO_KTS /* m/s to knots */
#define	VELOCITY_MAX			 126.0*MPS_TO_KTS /* m/s to knots */
#define	SPECTRUM_WIDTH_MIN		   0.0*MPS_TO_KTS /* m/s to knots */
#define	SPECTRUM_WIDTH_MAX		  10.3*MPS_TO_KTS /* m/s to knots */
#define	DIFF_REFLECTIVITY_MIN		 -8.0
