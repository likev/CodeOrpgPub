...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 19:32:08 $
# $Id: rdasim_gui.mak,v 1.4 2014/03/07 19:32:08 steves Exp $
# $Revision: 1.4 $
# $State: Exp $
...
LOCAL_INCLUDES = -I.. -I$(MAKETOP)/src/cpc001 -I$(MAKETOP)/src/cpc102/tsk042
...
LOCAL_LIBRARIES = -lhci   -lrms_util   -lorpg -linfr
...
SRCS	=	rdasim_gui.c \
		rdasim_gui_send_command_popup.c \
		rdasim_gui_send_exception_popup.c	

TARGET = rda_simulator_gui
