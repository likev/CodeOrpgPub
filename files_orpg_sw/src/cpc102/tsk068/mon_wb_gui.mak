...
# $Id: mon_wb_gui.mak,v 1.6 2014/03/18 18:02:43 jeffs Exp $
# $Revision: 1.6 $
# $State: Exp $
...
LOCAL_INCLUDES = `pkg-config --cflags gtk+-2.0 gthread-2.0 libglade-2.0`
...
LIBPATH = `pkg-config --libs gtk+-2.0 gthread-2.0 libglade-2.0`
...
DEBUG_LOCALLIBS = $(LOCAL_LIBRARIES) -lbz2 -lz -Wl,-Bdynamic -ldl
...
# lnux_x86
lnux_x86_LD_OPTS = -Wl,--export-dynamic $(GTK_LD)
...
SRCS = mon_wb_gui.c mon_wb_gui_lib.c mon_wb_gui_callbacks.c 
