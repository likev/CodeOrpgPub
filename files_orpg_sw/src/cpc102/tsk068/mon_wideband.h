 ...
 * $Author: steves $
 * $Locker:  $
 * $Date: 2012/06/01 16:12:45 $
 * $Id: mon_wideband.h,v 1.2 2012/06/01 16:12:45 steves Exp $
 * $Revision: 1.2 $
 * $State: Exp $
 */  

#ifndef MON_WIDEBAND_H
#define MON_WIDEBAND_H
...
#define MONWB_RADIAL_STAT_LAST_ELEV_START	5
...
#define MONWB_BD_RADIAL_STAT_BEG_LAST_ELEV	5
