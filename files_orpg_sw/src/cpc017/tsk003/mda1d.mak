...
# $Author: steves $
# $Locker:  $
# $Date: 2004/03/03 20:46:37 $
# $Id: mda1d.mak,v 1.4 2004/03/03 20:46:37 steves Exp $
# $Revision: 1.4 $
# $State: Exp $
...
DEBUG_LOCALLIBS = $(LOCAL_LIBRARIES) -lbzip2 -lz
...
SRCS	=	mda1d_main.c \
		mda1d_acl.c \
		mda1d_find_shear.c \
		mda1d_search_core_shear.c \
		mda1d_set_table.c \
		mda1d_vect_sort.c \
		mda1d_finish_vectors.c \
		mda1d_conv_vector.c \
		mda1d_clean_duplicate.c \
		mda1d_shear_attributes.c 
