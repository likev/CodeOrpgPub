 ...
 * $Author: ryans $
 * $Locker:  $
 * $Date: 2005/03/03 22:20:19 $
 * $Id: mda3d_set_table.c,v 1.3 2005/03/03 22:20:19 ryans Exp $
 * $Revision: 1.3 $
 * $State: Exp $
 */
...
#define 	HALF_BIN_SIZE 0.125 /* the half bin size */
#define		TEN	      10.0 /* just a number 10.0 */
#define		FIVE	       5.0 /* just a number 5.0 */
#define         THREE          3.0 /* just a number 3.0 */
