...
# $Author: ccalvert $
# $Locker:  $
# $Date: 2004/02/05 23:04:37 $
# $Id: mdattnn.mak,v 1.3 2004/02/05 23:04:37 ccalvert Exp $
# $Revision: 1.3 $
# $State: Exp $
...
SRCS	=	mdattnn_main.c \
		...
		getAverageMotion.c \
		assignStormId.c \
		makeMesoAssociations.c \
		makeTVSAssociation.c \
		getTimeDiff.c \
                mda_ru_tracking_at_firstTilt.c \
                mda_ru_readInput_at_firstTilt.c \
                mda_ru_sort.c \
                mda_ru_extrapolate.c \
                mda_ru_downgrading_prevention.c \
		mda_sort.c
