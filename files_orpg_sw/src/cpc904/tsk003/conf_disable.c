/*   @(#) conf_disable.c 99/11/02 Version 1.7   */
...
Chg Date       Init Description
 1. 16-jul-98	rjp Added swap support.
...
#ifdef VXWORKS
int conf_disable (argc, argv, ptg)
#else 
int main (argc, argv)
#endif /* VXWORKS */
    int		argc;
...
#endif /* VXWORKS */
{
    ...
    */
    ...
    for ( i=0; i<num_links; i++ )
    {
        ...
        * Disable subnetwork
        */
       wanCommand (pNc, pServer, pService, pCtlrNumber, pSnids[i], W_DISABLE);
    }
    ...
    unsigned	command;
{
    ...
    */
    if (tracing == 1)
	printf ("Send W_DISABLE to wan layer.\n");
