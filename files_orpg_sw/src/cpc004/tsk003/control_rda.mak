...
# $Id: control_rda.mak,v 1.16 2014/03/07 18:51:26 steves Exp $
# $Revision: 1.16 $
# $State: Exp $

# Template make description file for describing a C binary file

CPC004_COMMON_DIR = ../tsk002
include $(MAKEINC)/make.common
include $(MAKEINC)/make.$(ARCH)
include $(CPC004_COMMON_DIR)/make.cpc004_common
