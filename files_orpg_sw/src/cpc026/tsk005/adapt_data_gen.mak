...
# $Author: ccalvert $
# $Locker:  $
# $Date: 2004/06/30 14:53:21 $
# $Id: adapt_data_gen.mak,v 1.4 2004/06/30 14:53:21 ccalvert Exp $
# $Revision: 1.4 $
# $State: Exp $
...
FC_LOCAL_LIBRARIES = -lorpg -linfr
...
# We cannot "makedepend" Fortran source files ... feel free to define
# a depend file for the C source files, if you like ...
DEPENDFILE =

FSRCS =	adapt_data_gen.ftn

CSRCS = save_adapt_data.c

ADDITIONAL_OBJS =

TARGET = adapt_data_gen
