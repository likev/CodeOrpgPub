 ...
 * $Author: ryans $
 * $Locker:  $
 * $Date: 2005/03/29 17:00:56 $
 * $Id: encrypt.c,v 1.1 2005/03/29 17:00:56 ryans Exp $
 * $Revision: 1.1 $
 * $State: Exp $
 */
...
static void 
my_encrypt (char *nachr, int decr)
{
...
static void Set_key_value ( char key[64], char *key_value ){
   ...
   j = 0;
   while( (*ptr != '\0') && ((ptr - key_value) < 8) ){

      /* Do For Each Bit in "ptr" */
      for( i = 0; i < 8; i++ ){
