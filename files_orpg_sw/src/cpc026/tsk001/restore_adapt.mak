...
# $Author: aamirn $
# $Locker:  $
# $Date: 2008/01/04 21:42:33 $
# $Id: restore_adapt.mak,v 1.6 2008/01/04 21:42:33 aamirn Exp $
# $Revision: 1.6 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lorpg -linfr -lpam
# Different order/set of libraries needed to build with debug information
DEBUG_LOCALLIBS = -lorpg -linfr -lbzip2 -lpam
...
SRCS =	restore_adapt.c

TARGET = restore_adapt
