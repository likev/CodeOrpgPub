...
# $Author: ccalvert $
# $Locker:  $
# $Date: 2011/05/23 17:08:50 $
# $Id: gdc.mak,v 1.7 2011/05/23 17:08:50 ccalvert Exp $
# $Revision: 1.7 $
# $State: Exp $
...
ALL_INCLUDES = $(STD_INCLUDES) $(LOCALTOP_INCLUDES) $(TOP_INCLUDES) \
	$(LOCAL_INCLUDES) $(SYS_INCLUDES) -I/usr/include/libxml2 -std=gnu89
...
LOCAL_LIBRARIES = $(LIBDIR)/libinfr.a -lxml2 -ldl
...
SRCS =  gdc_main.c gdc_parse.c gdc_fr_site.c gdc_read_data.c \
        gdc_expression.c gdc_files.c gdc_variable.c
