...
# $Id: mnttsk_loadshed.mak,v 1.11 2014/03/07 19:11:39 steves Exp $
# $Revision: 1.11 $
# $State: Exp $

# Make description file for building the Load Shed Maintenance Task
...
SRCS = mnttsk_loadshed.c \
       mnttsk_ls_levels.c

ADDITIONAL_OBJS =

TARGET = mnttsk_loadshed
