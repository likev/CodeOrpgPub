...
# $Id: mnttsk_prod_gen.mak,v 1.14 2014/03/07 19:11:41 steves Exp $
# $Revision: 1.14 $
# $State: Exp $

# Make description file for building the RPG Product Generation
# Maintenance Task
...
#
# the RPG-Specific MNTTSK Library requires the Maintenance Tasks Library
#
...
SRCS = mnttsk_prod_gen.c \
       mnttsk_pg_rt_request.c

ADDITIONAL_OBJS =

TARGET = mnttsk_prod_gen
