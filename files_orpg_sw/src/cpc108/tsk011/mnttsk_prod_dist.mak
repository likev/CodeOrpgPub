...
# $Id: mnttsk_prod_dist.mak,v 1.17 2014/03/07 19:11:40 steves Exp $
# $Revision: 1.17 $
# $State: Exp $

# Make description file for building the RPG Product Distribution
# Maintenance Task
...
SRCS = mnttsk_prod_dist.c \
       mnttsk_init_user_db.c

ADDITIONAL_OBJS =

TARGET = mnttsk_prod_dist
