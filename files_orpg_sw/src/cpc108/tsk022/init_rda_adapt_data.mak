...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 19:11:38 $
# $Id: init_rda_adapt_data.mak,v 1.4 2014/03/07 19:11:38 steves Exp $
# $Revision: 1.4 $
# $State: Exp $

# Make description file for building the RDA Adaptation Data Init Task
...
SRCS = init_rda_adapt_data.c

ADDITIONAL_OBJS =

TARGET = init_rda_adapt_data
