...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 18:45:03 $
# $Id: hci_ccz_legacy.mak,v 1.7 2014/03/07 18:45:03 steves Exp $
# $Revision: 1.7 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lhci -lrpgc -lorpg -linfr -lm
...
SRCS	=	hci_clutter_censor_zones_editor_legacy.c	\
		hci_clutter_censor_zones_functions_legacy.c
	

TARGET = hci_ccz_legacy
