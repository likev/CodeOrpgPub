...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 18:45:07 $
# $Id: hci_restore_adapt.mak,v 1.6 2014/03/07 18:45:07 steves Exp $
# $Revision: 1.6 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lhci -lorpg -linfr -lpam
...
SRCS	=	hci_restore_adapt.c

TARGET = hci_restore_adapt
