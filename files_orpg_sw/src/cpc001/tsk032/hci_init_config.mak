...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 18:45:04 $
# $Id: hci_init_config.mak,v 1.8 2014/03/07 18:45:04 steves Exp $
# $Revision: 1.8 $
# $State: Exp $
...
# lnux_x86
lnux_x86_LD_OPTS = -lnsl -ldl -lrt -lcrypt

lnux_x86_DEBUG_LD_OPTS = -lnsl -ldl -lrt -lcrypt
...
SRCS	=   hci_init_config.c
	

TARGET = hci_init_config
