...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 18:45:05 $
# $Id: hci_precip_status.mak,v 1.5 2014/03/07 18:45:05 steves Exp $
# $Revision: 1.5 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lhci -lrpgc -lorpg -linfr
...
SRCS	=	hci_precip_status.c
	

TARGET = hci_precip_status
