/************************************************************************
 *									*
 *	Module:  hci_blockage_display_radial_data.c			*
 *									*
 ...
 * $Author: ccalvert $
 * $Locker:  $
 * $Date: 2012/03/12 13:26:11 $
 * $Id: hci_blockage_display_radial_data.c,v 1.3 2012/03/12 13:26:11 ccalvert Exp $
 * $Revision: 1.3 $
 * $State: Exp $
 */
...
/************************************************************************
 *	Description: This function is used to display a blockage data	*
	...
	for (i=0;i<radial->bins;i++) {
		...
		case 3 :
		    ...
		    break;
                 ...
                 /* 20120119 Ward CCR NA12-00054. Make transparent at 0 %  *
                  * level. Added a filter 4, copied from filter 0, changed *
                  * color->min_value comparison from < to <=               */

                 case 4 : /* copied from case 0, changed to <= */
