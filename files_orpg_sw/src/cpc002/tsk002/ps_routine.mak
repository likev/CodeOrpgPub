...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 18:46:05 $
# $Id: ps_routine.mak,v 1.12 2014/03/07 18:46:05 steves Exp $
# $Revision: 1.12 $
# $State: Exp $
...
DEBUG_LOCALLIBS = -lorpg -lorpg -linfr
...
lnux_x86_GPROF_LD_OPTS = $(lnux_x86_LD_OPTS)
...
SRCS = ps_main.c \
        ps_prod_task_tables.c \
	ps_process_events.c \
	ps_process_msg.c \
	ps_handle_prod.c \
	ps_convert_params.c \
	ps_rda_rpg_status.c \
	ps_task_status_list.c \
	ps_vol_prod_list.c \
        ps_monitor_cpu.c
