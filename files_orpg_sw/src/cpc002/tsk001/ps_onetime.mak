...
# $Id: ps_onetime.mak,v 1.14 2014/03/07 18:46:04 steves Exp $
# $Revision: 1.14 $
# $State: Exp $
...
DEBUG_LOCALLIBS = -lorpg -lrpgc -linfr -lm
...
SRCS = otr_main.c \
	otr_find_product.c \
	otr_reply_to_request.c \
	otr_process_onetime_requests.c \
	otr_alert_paired_product_request.c \
