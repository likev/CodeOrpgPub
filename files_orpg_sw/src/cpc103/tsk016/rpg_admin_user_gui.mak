...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 19:08:32 $
# $Id: rpg_admin_user_gui.mak,v 1.9 2014/03/07 19:08:32 steves Exp $
# $Revision: 1.9 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lhci -lorpg -linfr -lpam -lcrack -lcrypt
...
SRCS = rpg_admin_user_gui.c

ADDITIONAL_OBJS =

TARGET = rpg_admin_user
