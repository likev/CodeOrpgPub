 ...
 * $Author: ccalvert $
 * $Locker:  $
 * $Date: 2004/01/21 20:25:09 $
 * $Id: short_isbyte.c,v 1.1 2004/01/21 20:25:09 ccalvert Exp $
 * $Revision: 1.1 $
 * $State: Exp $
 */
...
************************************************************************/
int short_isbyte(short input_word, unsigned short *output_word, int store_position) {
