...
# $Id: saausers.mak,v 1.6 2014/03/07 18:57:14 steves Exp $
# $Revision: 1.6 $
# $State: Exp $
...
LOCAL_LIBRARIES = -lrpgc -lorpg -linfr -lm -lsaa
...
SRCS	=	saausers_main.c \
		saabuild_usp.c \
		saausers_symb_layer.c \
		saausers_tab.c \
		saaaccum_usp.c \
		saausers_io_functions.c \
		saausers_nullsymb_layer.c \
		get_saa_usp_requests.c
