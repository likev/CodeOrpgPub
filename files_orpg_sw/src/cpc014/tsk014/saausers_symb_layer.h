 ...
 * $Author: ccalvert $
 * $Locker:  $
 * $Date: 2008/02/15 16:40:07 $
 * $Id: saausers_symb_layer.h,v 1.2 2008/02/15 16:40:07 ccalvert Exp $
 * $Revision: 1.2 $
 * $State: Exp $
 */
...
#ifndef _SAAUSERS_SYMB_LAYER_H_
#define _SAAUSERS_SYMB_LAYER_H_
...
#define TAB_CUSHION  3420   /* Approximate size of tabular portion of 
