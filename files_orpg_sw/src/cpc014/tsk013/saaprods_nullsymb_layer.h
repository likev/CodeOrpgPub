 ...
 * $Id: saaprods_nullsymb_layer.h,v 1.2 2014/03/18 14:40:37 steves Exp $
 * $Revision: 1.2 $
 * $State: Exp $
 */
...
#ifndef _SAAPRODS_NULLSYMB_LAYER_H_
#define _SAAPRODS_NULLSYMB_LAYER_H_
...
typedef struct {
  ...
  short num_bytes;        /* Byte Length of Data Block (see ICD fig 3-8b) */
...
/* Error Messages                                                        */
  ...
  char *no_data_msg[4] = {"No buffer space for product                 ",
  	                  ...
  	                  "Insufficient data for hourly accumulation   ",
                          "First volume of accumulations               "};
