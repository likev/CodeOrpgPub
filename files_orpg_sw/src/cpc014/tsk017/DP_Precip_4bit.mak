...
# $Author: steves $
# $Locker:  $
# $Date: 2014/03/07 18:57:11 $
# $Id: DP_Precip_4bit.mak,v 1.5 2014/03/07 18:57:11 steves Exp $
# $Revision: 1.5 $
# $State: Exp $
...
SRCS	=       DP_Precip_4bit_main.c \
                DP_Precip_4bit_OHA_prod.c \
                DP_Precip_4bit_STA_prod.c \
                DP_Precip_4bit_STA_tab.c \
                DP_Precip_4bit_packetAF1Frle.c \
                DP_Precip_4bit_headerProd.c \
                DP_Precip_4bit_convert_func.c

TARGET =        dp_precip_4bit
